    ...
    <section id="products" className="bg-secondary/50 py-20 sm:py-28">
      <div className="section-shell">
        <SectionHeading
          ...
          title="Precision-built processing equipment"
          subtitle="Every unit is fabricated in-house from traceable stainless steel and tested before it leaves our floor."
        />
            ...
            >
              ...
              <div className="absolute inset-x-0 bottom-0 flex items-end justify-between gap-3 p-5">
                <div className="min-w-0">
                  <h3 className="truncate text-lg font-semibold text-white">{industry.name}</h3>
                  <p className="mt-1 text-xs text-white/75">{industry.text}</p>
                </div>
